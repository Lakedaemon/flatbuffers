...
class PhpGenerator : public BaseGenerator {
 ...
 private:
  ...
  void BeginFile(const bool needs_imports, std::string *code_ptr) {
    std::string &code = *code_ptr;
    code += "<?php\n";
    code = code + "// " + FlatBuffersGeneratedWarning();
    code += "namespace " + FullNamespace("\\") + ";\n\n";
  ...
  bool SaveType(const Definition &def, const std::string &classcode,
    ...
    std::string filename = namespace_dir_ + kPathSeparator + def.name + ".php";
...
#define FLATBUFFERS_TD(ENUM, IDLTYPE, CTYPE, JTYPE, GTYPE, NTYPE, PTYPE) #NTYPE,
